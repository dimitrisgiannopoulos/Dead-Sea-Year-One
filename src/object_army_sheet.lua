...
local UNITS = {
    ...
    {
        id = "u6",
        name_pos             = { x=-0.56,  z=0.208, width=860, font=60, height=110, align=ALIGN },
        type_pos             = { x=-0.297, z=0.208, width=230, font=30, height=120, align=ALIGN },
        combatRating_pos     = { x=-0.124, z=0.208, width=80,  font=30, height=120, align=ALIGN },

        hitPoints_pos        = { x=-0.680, z=0.280, width=130, font=40, height=90,  align=ALIGN },
        armor_pos            = { x=-0.625, z=0.280, width=130, font=40, height=90,  align=ALIGN },
        speed_pos            = { x=-0.570, z=0.280, width=130, font=40, height=90,  align=ALIGN },
        missileDefense_pos   = { x=-0.515, z=0.280, width=130, font=40, height=90,  align=ALIGN },
        meleeDefense_pos     = { x=-0.460, z=0.280, width=130, font=40, height=90,  align=ALIGN },
        morale_pos           = { x=-0.405, z=0.280, width=130, font=40, height=90,  align=ALIGN },
        meleeAttack_pos      = { x=-0.350, z=0.280, width=130, font=40, height=90,  align=ALIGN },
        rangedAttack_pos     = { x=-0.300, z=0.280, width=130, font=40, height=90,  align=ALIGN },
        damage_pos           = { x=-0.245, z=0.280, width=130, font=40, height=90,  align=ALIGN },
        minimumDamage_pos    = { x=-0.190, z=0.280, width=130, font=40, height=90,  align=ALIGN },
        armorProficiency_pos = { x=-0.135, z=0.280, width=130, font=40, height=90,  align=ALIGN },

        currentHitPoints_pos = { x=-0.040, z=0.228, width=400, font=40, height=90,  align=ALIGN },
        XP_pos               = { x=-0.020, z=0.29, width=200, font=30, height=120, align=ALIGN },
        feats_pos            = { x= 0.174, z=0.239, width=850, font=30, height=280, align=ALIGN },
        abilities_pos        = { x= 0.447, z=0.239, width=760, font=30, height=280, align=ALIGN },

        defaultAmmo = { origin = {x=0.600, z=0.194}, rows=2, cols=5, dx=0.020, dz=0.020, tooltip="Unit 6 Default Ammo" },
        specialAmmo = { origin = {x=0.592, z=0.246}, rows=3, cols=6, dx=0.018, dz=0.020, tooltip="Unit 6 Special Ammo" },
    },

    {
        id = "u7",
        name_pos             = { x=-0.56,  z=0.379, width=860, font=60, height=110, align=ALIGN },
        type_pos             = { x=-0.297, z=0.379, width=230, font=30, height=120, align=ALIGN },
        combatRating_pos     = { x=-0.124, z=0.379, width=80,  font=30, height=120, align=ALIGN },

        hitPoints_pos        = { x=-0.680, z=0.451, width=130, font=40, height=90,  align=ALIGN },
        armor_pos            = { x=-0.625, z=0.451, width=130, font=40, height=90,  align=ALIGN },
        speed_pos            = { x=-0.570, z=0.451, width=130, font=40, height=90,  align=ALIGN },
        missileDefense_pos   = { x=-0.515, z=0.451, width=130, font=40, height=90,  align=ALIGN },
        meleeDefense_pos     = { x=-0.460, z=0.451, width=130, font=40, height=90,  align=ALIGN },
        morale_pos           = { x=-0.405, z=0.451, width=130, font=40, height=90,  align=ALIGN },
        meleeAttack_pos      = { x=-0.350, z=0.451, width=130, font=40, height=90,  align=ALIGN },
        rangedAttack_pos     = { x=-0.300, z=0.451, width=130, font=40, height=90,  align=ALIGN },
        damage_pos           = { x=-0.245, z=0.451, width=130, font=40, height=90,  align=ALIGN },
        minimumDamage_pos    = { x=-0.190, z=0.451, width=130, font=40, height=90,  align=ALIGN },
        armorProficiency_pos = { x=-0.135, z=0.451, width=130, font=40, height=90,  align=ALIGN },

        currentHitPoints_pos = { x=-0.040, z=0.390, width=400, font=40, height=90,  align=ALIGN },
        XP_pos               = { x=-0.020, z=0.46, width=200, font=30, height=120, align=ALIGN },
        feats_pos            = { x= 0.174, z=0.410, width=850, font=30, height=280, align=ALIGN },
        abilities_pos        = { x= 0.447, z=0.410, width=760, font=30, height=280, align=ALIGN },

        defaultAmmo = { origin = {x=0.600, z=0.365}, rows=2, cols=5, dx=0.020, dz=0.020, tooltip="Unit 7 Default Ammo" },
        specialAmmo = { origin = {x=0.592, z=0.417}, rows=3, cols=6, dx=0.018, dz=0.020, tooltip="Unit 7 Special Ammo" },
    },

    {
        id = "u8",
        name_pos             = { x=-0.56,  z=0.550, width=860, font=60, height=110, align=ALIGN },
        type_pos             = { x=-0.297, z=0.550, width=230, font=30, height=120, align=ALIGN },
        combatRating_pos     = { x=-0.124, z=0.550, width=80,  font=30, height=120, align=ALIGN },

        hitPoints_pos        = { x=-0.680, z=0.622, width=130, font=40, height=90,  align=ALIGN },
        armor_pos            = { x=-0.625, z=0.622, width=130, font=40, height=90,  align=ALIGN },
        speed_pos            = { x=-0.570, z=0.622, width=130, font=40, height=90,  align=ALIGN },
        missileDefense_pos   = { x=-0.515, z=0.622, width=130, font=40, height=90,  align=ALIGN },
        meleeDefense_pos     = { x=-0.460, z=0.622, width=130, font=40, height=90,  align=ALIGN },
        morale_pos           = { x=-0.405, z=0.622, width=130, font=40, height=90,  align=ALIGN },
        meleeAttack_pos      = { x=-0.350, z=0.622, width=130, font=40, height=90,  align=ALIGN },
        rangedAttack_pos     = { x=-0.300, z=0.622, width=130, font=40, height=90,  align=ALIGN },
        damage_pos           = { x=-0.245, z=0.622, width=130, font=40, height=90,  align=ALIGN },
        minimumDamage_pos    = { x=-0.190, z=0.622, width=130, font=40, height=90,  align=ALIGN },
        armorProficiency_pos = { x=-0.135, z=0.622, width=130, font=40, height=90,  align=ALIGN },

        currentHitPoints_pos = { x=-0.040, z=0.561, width=400, font=40, height=90,  align=ALIGN },
        XP_pos               = { x=-0.020, z=0.626, width=200, font=30, height=120, align=ALIGN },
        feats_pos            = { x= 0.174, z=0.581, width=850, font=30, height=280, align=ALIGN },
        abilities_pos        = { x= 0.447, z=0.581, width=760, font=30, height=280, align=ALIGN },

        defaultAmmo = { origin = {x=0.600, z=0.536}, rows=2, cols=5, dx=0.020, dz=0.020, tooltip="Unit 8 Default Ammo" },
        specialAmmo = { origin = {x=0.592, z=0.588}, rows=3, cols=6, dx=0.018, dz=0.020, tooltip="Unit 8 Special Ammo" },
    },

    {
        id = "u9",
        name_pos             = { x=-0.56,  z=0.721, width=860, font=60, height=110, align=ALIGN },
        type_pos             = { x=-0.297, z=0.721, width=230, font=30, height=120, align=ALIGN },
        combatRating_pos     = { x=-0.124, z=0.721, width=80,  font=30, height=120, align=ALIGN },

        hitPoints_pos        = { x=-0.680, z=0.793, width=130, font=40, height=90,  align=ALIGN },
        armor_pos            = { x=-0.625, z=0.793, width=130, font=40, height=90,  align=ALIGN },
        speed_pos            = { x=-0.570, z=0.793, width=130, font=40, height=90,  align=ALIGN },
        missileDefense_pos   = { x=-0.515, z=0.793, width=130, font=40, height=90,  align=ALIGN },
        meleeDefense_pos     = { x=-0.460, z=0.793, width=130, font=40, height=90,  align=ALIGN },
        morale_pos           = { x=-0.405, z=0.793, width=130, font=40, height=90,  align=ALIGN },
        meleeAttack_pos      = { x=-0.350, z=0.793, width=130, font=40, height=90,  align=ALIGN },
        rangedAttack_pos     = { x=-0.300, z=0.793, width=130, font=40, height=90,  align=ALIGN },
        damage_pos           = { x=-0.245, z=0.793, width=130, font=40, height=90,  align=ALIGN },
        minimumDamage_pos    = { x=-0.190, z=0.793, width=130, font=40, height=90,  align=ALIGN },
        armorProficiency_pos = { x=-0.135, z=0.793, width=130, font=40, height=90,  align=ALIGN },

        currentHitPoints_pos = { x=-0.040, z=0.732, width=400, font=40, height=90,  align=ALIGN },
        XP_pos               = { x=-0.020, z=0.797, width=200, font=30, height=120, align=ALIGN },
        feats_pos            = { x= 0.174, z=0.752, width=850, font=30, height=280, align=ALIGN },
        abilities_pos        = { x= 0.447, z=0.752, width=760, font=30, height=280, align=ALIGN },

        defaultAmmo = { origin = {x=0.600, z=0.707}, rows=2, cols=5, dx=0.020, dz=0.020, tooltip="Unit 9 Default Ammo" },
        specialAmmo = { origin = {x=0.592, z=0.759}, rows=3, cols=6, dx=0.018, dz=0.020, tooltip="Unit 9 Special Ammo" },
    },

    {
        id = "u10",
        name_pos             = { x=-0.56,  z=0.892, width=860, font=60, height=110, align=ALIGN },
        type_pos             = { x=-0.297, z=0.892, width=230, font=30, height=120, align=ALIGN },
        combatRating_pos     = { x=-0.124, z=0.892, width=80,  font=30, height=120, align=ALIGN },

        hitPoints_pos        = { x=-0.680, z=0.964, width=130, font=40, height=90,  align=ALIGN },
        armor_pos            = { x=-0.625, z=0.964, width=130, font=40, height=90,  align=ALIGN },
        speed_pos            = { x=-0.570, z=0.964, width=130, font=40, height=90,  align=ALIGN },
        missileDefense_pos   = { x=-0.515, z=0.964, width=130, font=40, height=90,  align=ALIGN },
        meleeDefense_pos     = { x=-0.460, z=0.964, width=130, font=40, height=90,  align=ALIGN },
        morale_pos           = { x=-0.405, z=0.964, width=130, font=40, height=90,  align=ALIGN },
        meleeAttack_pos      = { x=-0.350, z=0.964, width=130, font=40, height=90,  align=ALIGN },
        rangedAttack_pos     = { x=-0.300, z=0.964, width=130, font=40, height=90,  align=ALIGN },
        damage_pos           = { x=-0.245, z=0.964, width=130, font=40, height=90,  align=ALIGN },
        minimumDamage_pos    = { x=-0.190, z=0.964, width=130, font=40, height=90,  align=ALIGN },
        armorProficiency_pos = { x=-0.135, z=0.964, width=130, font=40, height=90,  align=ALIGN },

        currentHitPoints_pos = { x=-0.040, z=0.905, width=400, font=40, height=90,  align=ALIGN },
        XP_pos               = { x=-0.020, z=0.968, width=200, font=30, height=120, align=ALIGN },
        feats_pos            = { x= 0.174, z=0.923, width=850, font=30, height=280, align=ALIGN },
        abilities_pos        = { x= 0.447, z=0.923, width=760, font=30, height=280, align=ALIGN },

        defaultAmmo = { origin = {x=0.600, z=0.878}, rows=2, cols=5, dx=0.020, dz=0.020, tooltip="Unit 10 Default Ammo" },
        specialAmmo = { origin = {x=0.592, z=0.930}, rows=3, cols=6, dx=0.018, dz=0.020, tooltip="Unit 10 Special Ammo" },
    },
